...
class HydrogenClientEvent extends  EventEmitter {
    constructor(client) {
        super();
        this.client = client;
        if (this.constructor === HydrogenClientEvent) throw new TypeError('Ja na lode');
...
module.exports = HydrogenClientEvent;