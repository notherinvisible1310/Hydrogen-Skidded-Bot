...
const HydrogenClientEvents = require(`../../structures/Eventhandler`);

class HydrogenInteractions extends HydrogenClientEvents{
    get name(){
        ...
        if(interaction.isButton())
        {
            ...
            if(interaction.customId === `pl2`)
            {
                ...
                if(interaction.member.voice.channelId !== interaction.guild.members.me.voice.channelId)
                {
                    ...
                    let but2 = new ButtonBuilder().setStyle(ButtonStyle.Secondary).setLabel(!player.isPaused ? `Resume` : `Pause`).setCustomId(`pl2`);
...
module.exports = HydrogenInteractions;